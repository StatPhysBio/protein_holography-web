...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', "--pdb_file_in", type=str)
    parser.add_argument('-o', "--out_dir", type=str, default='./rasp_preprocess')
    parser.add_argument("--reduce_exe", type=str, default='./reduce/reduce_src/reduce')
