...
if __name__ == '__main__':
    ...
    ## TODO: repeat this but only with ddg values between -1 and 7

    df = pd.read_csv(f'{args.model_version}/zero_shot_predictions/{args.system_name}-{model_version_in_filename}-use_mt_structure={args.use_mt_structure}.csv')
    ...
    # save correlations
    with open(f'{args.model_version}/zero_shot_predictions/{args.system_name}-{model_version_in_filename}-use_mt_structure={args.use_mt_structure}_correlations.json', 'w') as f:
