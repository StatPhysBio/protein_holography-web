...
if __name__ == '__main__':
    ...
    df = pd.read_csv(f'{args.system_name}/{args.model_version}/zero_shot_predictions/{args.system_name.lower()}_ddg_experimental-{model_version_in_filename}-use_mt_structure={args.use_mt_structure}.csv')
    ...
    # save correlations
    with open(f'{args.system_name}/{args.model_version}/zero_shot_predictions/{args.system_name.lower()}_ddg_experimental-{model_version_in_filename}-use_mt_structure={args.use_mt_structure}_correlations.json', 'w') as f:
