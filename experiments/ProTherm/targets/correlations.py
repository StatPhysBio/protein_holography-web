...
if __name__ == '__main__':
    ...
    df = pd.read_csv(f'{args.model_version}/zero_shot_predictions/protherm_targets_ddg_experimental-{args.model_version}-use_mt_structure={args.use_mt_structure}.csv')
    ...
    # save correlations
    with open(f'{args.model_version}/zero_shot_predictions/protherm_targets_ddg_experimental-{args.model_version}-use_mt_structure={args.use_mt_structure}_correlations.json', 'w') as f:
